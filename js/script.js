...
// });
// document.querySelector(".cardVideo").addEventListener("click", () => {
...
// document
//   .querySelector(".cancelVideoButton")
...
// document.querySelector(".moveNext").addEventListener("click", () => {
//   slidePositon === 0 ? (slidePositon = slideNumber) : slidePositon--;
//   updatePosition();
// });

// document.querySelector(".movePrev").addEventListener("click", () => {
...
document.querySelector(".myage").innerHTML = Math.abs(
  new Date(new Date("11/27/2000") - new Date()).getUTCFullYear() - 1970
);
